...
<head>
    ...
    <title>Data Siswa - LABKEY SYSTEM</title>
...
<body>
    ...
    <div class="content">
        <div class="page-header d-flex justify-content-between align-items-center">
            <h3 class="page-title">Data <span>Siswa</span></h3>
        </div>
        ...
        <div class="card-custom mb-4">
            <h5 class="mb-3 text-warning"><i class="bi bi-person-plus-fill me-2"></i>Tambah Data Siswa</h5>
            <form method="POST" action="/students/add">
                @csrf
                <div class="row g-3">
                    <div class="col-md-3">
                        <input type="text" class="form-control form-control-dark" name="nama" placeholder="Nama Lengkap" required>
                    </div>
                    <div class="col-md-3">
                        <input type="text" class="form-control form-control-dark" name="kelas" placeholder="Kelas" required>
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control form-control-dark" name="rfid_uid" placeholder="RFID UID" required>
                    </div>
                    <div class="col-md-2">
                ...
                <table class="table table-dark-custom table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-secondary">{{ $student->kelas }}</span></td>
                            <td><code class="text-warning bg-dark px-2 py-1 rounded border border-secondary">{{ $student->rfid_uid }}</code></td>
